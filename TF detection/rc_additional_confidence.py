...
Usage:
    python3 rc_additional_confidence.py
...
MODEL_PATH = "best_saved_model/best.onnx"  # Update path after copying model to Pi
CONFIDENCE_THRESHOLD = 0.5
IMG_SIZE = 320          # Must match export size
DISPLAY_OUTPUT = False  # Set True if you have a monitor connected to see the boxes
